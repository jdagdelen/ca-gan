...
def init():
    ...
    parser.add_argument('--project_root', type=str, default=root, help='project directory path')
	parser.add_argument('--root', type=str, default=root+'/data', help='image source folder')
    parser.add_argument('--checkpoint', type=str, default=root+'/.checkpoint', help='checkpoint folder')
    parser.add_argument('--gen_root', type=str, default=root+'/Gen_images', help='images generated to')
    ...
    parser.add_argument('--infofile', default=[root+'/data/list_train_F.txt', root+'/data/list_test_F.txt'], help='info files for test and train data paths')
    ...
    parser.add_argument("--model_dir", type=str, default=root+"/models/",
                        help="directory for vgg, if model is not present in the directory it is downloaded")
    parser.add_argument('--model_vgg', type=str, default=root+'/pre_trained_models/vgg.model', help='vgg model')
    parser.add_argument('--styleParam', type=float, default=5.0, help='')

    parser.add_argument('--lambda_vgg16', type=float, default=5.0, help='')
    parser.add_argument('--vgg16', type=str, default=root+'/pre_trained_models/vgg.model', help='vgg model')
    parser.add_argument('--output', type=str, default=root+"/output", help=' ')
